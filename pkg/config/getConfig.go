...
func readFlags(cfg *Config) {
	...
	flag.StringVar(&cfg.TableNameGlobal, "tableNameGlobal", cfg.TableNameGlobal, "The name of table with global cycle")
	flag.StringVar(&cfg.TableNameResult, "tableNameResult", cfg.TableNameResult, "The name of table with result")
